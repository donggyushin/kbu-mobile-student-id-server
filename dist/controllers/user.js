...
exports.newAccount = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, studentId, id, password, phoneNumber, token;
    return __generator(this, function (_b) {
        _a = req.body, name = _a.name, studentId = _a.studentId, id = _a.id, password = _a.password, phoneNumber = _a.phoneNumber;
        token = jsonwebtoken_1.generateToken(id);
        res.json({
            ok: true,
            error: null,
            token: token
